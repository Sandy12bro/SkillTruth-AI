        ...
        {isAnalyzing ? (
          ...
          >
            <header className="mb-8 md:mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
              <div>
                <h1 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Analysis Intelligence</h1>
                <p className="text-sm md:text-base text-slate-500 dark:text-slate-400">Structured professional breakdown generated by AI.</p>
              </div>
              <div className="flex flex-col items-start md:items-end">
                <span className="text-[10px] font-bold text-indigo-500 uppercase tracking-widest">Confidence Score</span>
                <span className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white">94%</span>
              </div>
            </header>
